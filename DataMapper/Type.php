...
Type::getInstance()
    ->register('common', '\InterfaceWorker\DataMapper\Types\Common')
    ->register('datetime', '\InterfaceWorker\DataMapper\Types\Date')
    ->register('integer', '\InterfaceWorker\DataMapper\Types\Integer')
    ->register('json', '\InterfaceWorker\DataMapper\Types\Json')
    ->register('number', '\InterfaceWorker\DataMapper\Types\Number')
    ->register('string', '\InterfaceWorker\DataMapper\Types\Text')
    ->register('uuid', '\InterfaceWorker\DataMapper\Types\UUID')
    ->register('complex', '\InterfaceWorker\DataMapper\Types\Complex');
