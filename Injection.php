...
class Injection implements ArrayAccess {
    ...
    public function onConstruct() {
        $this->request = 'InterfaceWorker\Request\CoapRequest';
        $this->response = 'InterfaceWorker\Response\CoapResponse';
        $this->clientsUid = array();
